$(function(){
  $('#about-tab').on('click', function(){
      ...
      $('#about').html(
        ...
        +'</h3>'
        +'<h4 class="subtitle is-4">LTとは，５分程度で行われるプレゼンテーションのことです．</h4>'
        +'<h3 class="title is-2">'
        +'  <span class="icon is-medium">'
        +'    <i class="fa fa-pencil"></i>'
        +'  </span>'
        +'  どんな話をするの？'
        +'</h3>'
        +'<h4 class="subtitle is-4">技術系の話から好きな食べ物の話まで様々ですので，自分の興味のあるテーマを持ち込んで話してみましょう．</h4>'
        +'<h3 class="title is-2">'
        +'  <span class="icon is-medium">'
        +'    <i class="fa fa-pencil"></i>'
        +'  </span>'
        +'  どうしてはじまったの？'
        +'</h3>'
        +'<h4 class="subtitle is-4 is-not-last">こういったLTイベントは実は全国で開催されていますが，多くは誰でも参加OKのイベントとなっており，初参加者からすると少しハードルの高いものになっています．</h4>'
        +'<h4 class="subtitle is-4">そこでまずは学内限定イベントから気軽に参加してもらうことで，こういったイベントになれるとともに，農工大生同士でいろいろな情報を共有し合おうという意図で始まったイベントです．</h4>'
      );
    }
  );
